...
import fr.cnes.regards.modules.search.service.GreetingsService;
 ...
 */
@RestController
@ModuleInfo(name="search", version="1.0-SNAPSHOT", author="REGARDS", legalOwner="CS", documentation="http://test")
@RequestMapping("/api")
