...
public class CatalogController {
    ...
    @ResponseBody
    public ResponseEntity<PagedResources<Resource<AbstractEntity>>> searchAll(@RequestParam Map<String,String> pQ,
    ...
    @ResourceAccess(
            description = "Perform an OpenSearch request on all indexed data, regardless of the type. The return objects can be any mix of collection, dataset, dataobject and document.")
    @ResponseBody
    public ResponseEntity<FacettedPagedResources<Resource<AbstractEntity>>> searchAll(@RequestParam Map<String,String> pQ,
    ...
    @ResponseBody
    public ResponseEntity<PagedResources<Resource<Collection>>> searchCollections(@RequestParam Map<String,String> pQ,
    ...
    @ResponseBody
    public ResponseEntity<PagedResources<Resource<Dataset>>> searchDatasets(@RequestParam Map<String,String> pQ,
            final Pageable pPageable) throws SearchException {
    ...
    @ResponseBody
    public ResponseEntity<FacettedPagedResources<Resource<DataObject>>> searchDataobjects(@RequestParam Map<String,String> pQ,
            @RequestParam(value = "facets", required = false) Map<String, FacetType> pFacets, final Pageable pPageable)
            throws SearchException {
    ...
    public ResponseEntity<PagedResources<Resource<Dataset>>> searchDataobjectsReturnDatasets(
            @RequestParam Map<String,String> pQ,
            @RequestParam(value = "facets", required = false) Map<String, FacetType> pFacets, final Pageable pPageable,
    ...
    @ResponseBody
    public ResponseEntity<PagedResources<Resource<Document>>> searchDocuments(@RequestParam Map<String,String> pQ,
