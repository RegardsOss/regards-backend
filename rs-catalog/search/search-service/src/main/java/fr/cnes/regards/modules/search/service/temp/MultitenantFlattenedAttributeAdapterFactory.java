 ...
 * LICENSE_PLACEHOLDER
 */
package fr.cnes.regards.modules.search.service.temp;
...
public class MultitenantFlattenedAttributeAdapterFactory
    ...
    @PostConstruct
    public void init() {
        registerSubtype("project1", ObjectAttribute.class, "FragmentDataobject");
        registerSubtype("project1", StringAttribute.class, "test");
    ...
    /**
     * Flatten a {@link JsonElement} carrying key and value in separated fields into a single field whose key is the value of the key field and value the value of the value field
     *
