...
public class FileAvailabilityException extends ModuleException {
    ...
    private final NotAvailabilityCauseEnum notAvailabilityCause;

    public FileAvailabilityException(NotAvailabilityCauseEnum notAvailabilityCause, String message) {
        super(message);
        this.notAvailabilityCause = notAvailabilityCause;
    }

    public NotAvailabilityCauseEnum getNotAvailabilityCause() {
