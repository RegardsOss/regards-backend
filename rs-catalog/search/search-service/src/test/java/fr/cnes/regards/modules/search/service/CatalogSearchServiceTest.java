...
public class CatalogSearchServiceTest {
    ...
    @Test
    public void testGetDocumentWithStats()
        throws SearchException, EntityNotFoundException, EntityOperationForbiddenException, AccessRightFilterException {
        ...
        QueryableAttribute creationDateAttribute = new QueryableAttribute("creationDate", null, true, 0, false);
        ...
        CollectionWithStats documentsWithStats = catalogSearchService.getCollectionWithDataObjectsStats(urn,
                                                                                                        searchType,
                                                                                                        Sets.newHashSet(
