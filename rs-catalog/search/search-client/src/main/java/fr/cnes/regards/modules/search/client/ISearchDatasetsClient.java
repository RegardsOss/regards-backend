...
/**
 * Feign client for calling rs-catalog's CatalogController#searchDatasets.
 * <p>
...
@RequestMapping(value = "/datasets/search", consumes = MediaType.APPLICATION_JSON_UTF8_VALUE,
        produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
@FunctionalInterface
public interface ISearchDatasetsClient {
