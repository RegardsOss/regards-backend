...
/**
 * Feign client for calling rs-catalog's {@link CatalogController#searchDocuments}.
 * <p>
...
@RequestMapping(value = CatalogController.DOCUMENTS_SEARCH, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE,
        produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
@FunctionalInterface
public interface ISearchDocumentsClient {
