...
public interface IBatchHandler<M> extends IHandler<M> {
    ...
    /**
     * This method need to be implemented if the message might be generated by an external system.
     * Used to inject type and converter (Jackson / Gson) in the headers of a message being deserialized.
     *
     * @return generic type
     */
