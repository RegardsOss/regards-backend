...
import fr.cnes.regards.framework.oais.dto.validator.SIPChecksumValidator;
...
/**
 * Test for {@link SIPChecksumValidator}
 *
 * @author Thibaud Michaudel
 **/
public class SipChecksumValidatorTest {
    ...
    private Set<ConstraintViolation<SIPReference>> validateChecksum(String checksum, String algorithm) {
        try {
            SIPReference reference = new SIPReference();
            reference.setAlgorithm(algorithm);
            reference.setChecksum(checksum);
            reference.setUrl(new URL("http://url.com"));
