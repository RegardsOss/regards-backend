...
public class OaisFieldDescriptors {
    ...
    private List<FieldDescriptor> buildDataObjectDescription(String prefix) {
        ...
        lfd.add(oaisDataObjectField
                        .withPath(addPrefix(prefix, "regardsDataType"), "regardsDataType", "REGARDS data object type",
        ...
        lfd.add(oaisDataObjectField
                        .withPath(addPrefix(prefix, "checksum"), "checksum", "The calculated data object checksum"));
