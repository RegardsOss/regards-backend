...
public class OaisFieldDescriptors {
    ...
    public List<FieldDescriptor> build() {
         ...
         */
        lfd.add(contentInformationField.withPath(addPrefix("properties.contentInformations[].representationInformation"),
         ...
         * Data object
         */
        lfd.add(contentInformationField.withPath(addPrefix("properties.contentInformations[].dataObject"),
                                                 "dataObject",
                                                 "A data object"));
        ...
        lfd.add(informationPackageField.withPath(addPrefix("properties.pdi"),
                                                 "pdi",
    ...
    private List<FieldDescriptor> buildSyntaxDescription(String prefix) {
        ...
        lfd.add(syntaxField.withPath(addPrefix(prefix, "description"), "description", "A description")
                           .optional()
                           .type(STRING));
        lfd.add(syntaxField.withPath(addPrefix(prefix, "mimeType"),
                                     "mimetype",
    ...
    private List<FieldDescriptor> buildDataObjectDescription(String prefix) {
        ...
        lfd.add(oaisDataObjectField.withPath(addPrefix(prefix, "regardsDataType"),
                                             "regardsDataType",
                                             "REGARDS data object type",
        ...
        lfd.add(oaisDataObjectField.withPath(addPrefix(prefix, "locations[].url"),
                                             "location URL",
        ...
        lfd.add(oaisDataObjectField.withPath(addPrefix(prefix, "checksum"),
                                             "checksum",
        ...
        lfd.add(oaisDataObjectField.withPath(addPrefix(prefix, "algorithm"),
                                             "algorithm-fake",
    ...
    private List<FieldDescriptor> buildPdiDescription(String prefix) {
        ...
        lfd.add(preservationField.withPath(addPrefix(prefix, "fixityInformation"),
                                           "fixityInformation",
        ...
        lfd.add(preservationField.withPath(addPrefix(prefix, "provenanceInformation"),
        ...
        lfd.add(preservationField.withPath(addPrefix(prefix, "accessRightInformation"),
    ...
    private List<FieldDescriptor> buildProvenanceDescription(String prefix) {
        ...
        lfd.add(provenanceField.withPath(addPrefix(prefix, "facility"), "facility", "A facility")
                               .optional()
                               .type(STRING));
        lfd.add(provenanceField.withPath(addPrefix(prefix, "instrument"), "instrument", "An instrument")
                               .optional()
                               .type(STRING));
        lfd.add(provenanceField.withPath(addPrefix(prefix, "filter"), "filter", "A filter").optional().type(STRING));
        lfd.add(provenanceField.withPath(addPrefix(prefix, "detector"), "detector", "A detector")
                               .optional()
                               .type(STRING));
        lfd.add(provenanceField.withPath(addPrefix(prefix, "proposal"), "proposal", "A proposal")
                               .optional()
                               .type(STRING));
    ...
    private List<FieldDescriptor> buildEventDescription(String prefix) {
        ...
        lfd.add(eventField.withPath(addPrefix(prefix, "date"),
                                    "date",
                                    "ISO Date time",
    ...
    private List<FieldDescriptor> buildAccessRightDescription(String prefix) {
        ...
        lfd.add(accessRightField.withPath(addPrefix(prefix, "publicReleaseDate"),
                                          "publicReleaseDate",
                                          "ISO Date time",
                                          "Required format : yyyy-MM-dd’T’HH:mm:ss.SSSZ").optional().type(STRING));
