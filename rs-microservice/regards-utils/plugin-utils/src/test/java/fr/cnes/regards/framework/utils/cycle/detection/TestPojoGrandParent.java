 ...
 * @author sbinda
 */
public class TestPojoGrandParent {
    ...
    public TestPojoParent getChild() {
        return child;
    }

    public void setChild(TestPojoParent child) {
        this.child = child;
    }
    ...
    public boolean equals(Object obj) {
        ...
        TestPojoGrandParent other = (TestPojoGrandParent) obj;
        if (child == null) {
            if (other.child != null) {
                return false;
            }
