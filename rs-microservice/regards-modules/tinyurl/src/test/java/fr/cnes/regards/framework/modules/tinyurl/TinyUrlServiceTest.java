...
public class TinyUrlServiceTest extends AbstractMultitenantServiceTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(TinyUrlServiceTest.class);
