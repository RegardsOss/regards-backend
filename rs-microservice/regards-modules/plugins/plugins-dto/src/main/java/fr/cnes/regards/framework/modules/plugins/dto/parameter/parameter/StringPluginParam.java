 ...
 * @author Marc SORDI
 */
public class StringPluginParam extends AbstractPluginParam<String> implements Cloneable {
    ...
    @Override
    public StringPluginParam clone() {
        return IPluginParam.build(this.name, this.getValue());
    }
}
