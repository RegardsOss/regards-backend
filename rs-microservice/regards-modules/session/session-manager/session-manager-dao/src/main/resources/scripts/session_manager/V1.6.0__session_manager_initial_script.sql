-- DELETE OLD SESSION MANAGER
DROP INDEX IF EXISTS idx_session_name, idx_session_state, idx_session_creation_date, idx_session_is_latest,
idx_last_update_date;
DROP TABLE IF EXISTS t_session;
DROP TABLE IF EXISTS session_schema_version;
