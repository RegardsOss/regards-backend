...
/**
 *  Override {@link AbstractMultitenantServiceTest} to provide Job Utils
 *
 * @author Léo Mieulet
 */
@ContextConfiguration(classes = { JobTestUtils.class })
@ActiveProfiles({ "nojobs" })
public abstract class AbstractMultitenantServiceWithJobTest extends AbstractMultitenantServiceTest {
