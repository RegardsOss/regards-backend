...
public interface IOnlineStorageLocation extends IStorageLocation {
    ...
    /**
     * Do retrieve action for the given {@link FileReferenceDto}
     *
     * @param fileReference FileReferenceDto to retrieve
     */
    InputStream retrieve(FileReferenceWithoutOwnersDto fileReference) throws ModuleException, FileNotFoundException;
