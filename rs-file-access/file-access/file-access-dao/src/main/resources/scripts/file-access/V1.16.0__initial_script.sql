...
ALTER TABLE ONLY t_storage_location_conf
    ADD CONSTRAINT uk_storage_loc_conf_type_priority UNIQUE (storage_type, priority);
...
ALTER TABLE ONLY t_storage_location_conf
    ADD CONSTRAINT fk_prioritized_storage_plugin_conf FOREIGN KEY (plugin_conf_id) REFERENCES t_plugin_configuration(id);
