 ...
 */
package fr.cnes.regards.modules.fileaccess.amqp;
...
public class StorageWorkerRequestEvent extends StorageWorkerRequestDto {
    ...
    public StorageWorkerRequestEvent(Long requestId,
                                     String storage,
                                     String checksum,
                                     String url,
                                     Path destination,
                                     AbstractStoragePluginConfigurationDto parameters) {
        super(requestId, storage, checksum, url, destination, parameters);
    }
}
