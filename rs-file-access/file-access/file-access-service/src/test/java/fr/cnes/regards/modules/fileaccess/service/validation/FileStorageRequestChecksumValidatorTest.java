...
import fr.cnes.regards.modules.fileaccess.dto.validation.FileStorageRequestChecksumValidator;
...
/**
 * Test for {@link FileStorageRequestChecksumValidator}
 */
public class FileStorageRequestChecksumValidatorTest {
    ...
    private Set<ConstraintViolation<FileStorageRequestDto>> validateChecksum(String checksum, String algorithm) {
        FileStorageRequestDto fileStorageRequestDto = FileStorageRequestDto.build("fileName",
                                                                                  checksum,
                                                                                  algorithm,
                                                                                  "text/plain",
                                                                                  "owner",
                                                                                  ...
                                                                                  "storage",
                                                                                  Optional.empty());
        return validator.validate(fileStorageRequestDto);
