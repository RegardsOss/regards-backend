...
public class FileStorageRequestReadyToProcessEventHandlerTest {
    ...
    public void test_3_ok_1_nok() {
        ...
        FileStorageRequestReadyToProcessEvent event1 = new FileStorageRequestReadyToProcessEvent("file-catalog.01",
                                                                                                 ...
                                                                                                 metaInfoDto,
                                                                                                 false);
        FileStorageRequestReadyToProcessEvent event2 = new FileStorageRequestReadyToProcessEvent("file-catalog.02",
                                                                                                 "checksum2",
                                                                                                 "MD5",
                                                                                                 "http://url2.com",
                                                                                                 STORAGE_NAME,
                                                                                                 ...
                                                                                                 metaInfoDto,
                                                                                                 false);
        FileStorageRequestReadyToProcessEvent event3 = new FileStorageRequestReadyToProcessEvent("file-catalog.03",
                                                                                                 "checksum3",
                                                                                                 "MD5",
                                                                                                 "http://url3.com",
                                                                                                 "Storage2",
                                                                                                 ...
                                                                                                 metaInfoDto,
                                                                                                 false);
        String errorRequestId = "file-catalog.04";
        FileStorageRequestReadyToProcessEvent event4 = new FileStorageRequestReadyToProcessEvent(errorRequestId,
                                                                                                 "checksum4",
                                                                                                 "MD5",
                                                                                                 "http://url4.com",
                                                                                                 "Storage3",
        ...
        // When
        fileStorageService.processStorageRequests(List.of(event1, event2, event3, event4));
        ...
        ArgumentCaptor<String> publishedRoutingKeyCaptor = ArgumentCaptor.forClass(String.class);
        Mockito.verify(publisher, Mockito.times(1))
               .publish(publishedEventCaptor.capture(), publishedRoutingKeyCaptor.capture());
        StorageResponseEvent event = publishedEventCaptor.getValue();
        String routingKey = publishedRoutingKeyCaptor.getValue();
        Assertions.assertEquals(errorRequestId, event.getRequestId(), "The request in error is not the expected one");
        Assertions.assertEquals(errorRequestId, routingKey, "The routing key should be the requestId");
    ...
    public void test_reference_ok() throws ModuleException {
        ...
        FileStorageRequestReadyToProcessEvent event = new FileStorageRequestReadyToProcessEvent(requestId,
                                                                                                "checksum1",
                                                                                                "MD5",
                                                                                                url,
                                                                                                pluginBusinessId,
        ...
        // When
        fileStorageService.processStorageRequests(List.of(event));

        // Then
        ArgumentCaptor<StorageResponseEvent> publishedEventsCaptor = ArgumentCaptor.forClass(StorageResponseEvent.class);
        ArgumentCaptor<String> publishedRoutingKeyCaptor = ArgumentCaptor.forClass(String.class);
        Mockito.verify(publisher, Mockito.times(1))
               .publish(publishedEventsCaptor.capture(), publishedRoutingKeyCaptor.capture());
        StorageResponseEvent sentEvent = publishedEventsCaptor.getValue();
        String routingKey = publishedRoutingKeyCaptor.getValue();
        Assertions.assertEquals(url, sentEvent.getUrl(), "The url should be the same one as the request");
        Assertions.assertEquals(requestId, routingKey, "The routing key should be the requestId");
        Assertions.assertNull(sentEvent.getErrorType(), "There should be no error");
    ...
    public void test_reference_nok() throws ModuleException {
        ...
        Assertions.assertEquals(url, sentEvent.getUrl(), "The url should be the same one as the request");
        Assertions.assertEquals(requestId, routingKey, "The routing key should be the requestId");
        Assertions.assertNotNull(sentEvent.getErrorType(), "There should be an error");
