 ...
 */
package fr.cnes.regards.modules.fileaccess.service.validation;

import fr.cnes.regards.modules.fileaccess.dto.request.FileReferenceRequestDto;
import fr.cnes.regards.modules.fileaccess.dto.validation.FileReferenceRequestChecksumValidator;
...
/**
 * Test for {@link FileReferenceRequestChecksumValidator}
 */
public class FileReferenceRequestChecksumValidatorTest {
    ...
    private Set<ConstraintViolation<FileReferenceRequestDto>> validateChecksum(String checksum, String algorithm) {
        FileReferenceRequestDto fileReferenceRequestDto = FileReferenceRequestDto.build("fileName",
                                                                                        checksum,
                                                                                        algorithm,
                                                                                        "text/plain",
                                                                                        0l,
                                                                                        ...
                                                                                        "SessionOwner",
                                                                                        "session");
        return validator.validate(fileReferenceRequestDto);
