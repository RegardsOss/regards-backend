 ...
 */
package fr.cnes.regards.modules.fileaccess.service.config;
...
/**
 * Module manager to import and export file access configurations
 *
 * @author Thibaud Michaudel
 **/
@Component
public class FileAccessModuleManager extends AbstractModuleManagerWithTenantSettings<Void> {

    private static final Logger LOGGER = LoggerFactory.getLogger(FileAccessModuleManager.class);
