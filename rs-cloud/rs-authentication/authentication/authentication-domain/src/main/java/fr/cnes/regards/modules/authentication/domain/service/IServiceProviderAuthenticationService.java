...
public interface IServiceProviderAuthenticationService {
    ...
    Try<Authentication> authenticate(String serviceProviderName, ServiceProviderAuthenticationParams params);

    Try<Unit> deauthenticate(String serviceProviderName);

    Try<Authentication> verifyAndAuthenticate(String externalToken);
}
