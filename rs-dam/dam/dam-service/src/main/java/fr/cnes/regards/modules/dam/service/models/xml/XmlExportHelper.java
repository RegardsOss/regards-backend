...
import fr.cnes.regards.modules.dam.service.models.exception.ExportException;
...
public final class XmlExportHelper {
    ...
    public static void exportFragment(OutputStream os,
            fr.cnes.regards.modules.dam.domain.models.attributes.Fragment fragment, List<AttributeModel> attributes)
            throws ExportException {
        write(os, Fragment.class, toXmlFragment(fragment, attributes));
    }

    public static void exportModel(OutputStream os, fr.cnes.regards.modules.dam.domain.models.Model model,
     ...
     */
    private static Model toXmlModel(fr.cnes.regards.modules.dam.domain.models.Model model, List<ModelAttrAssoc> attributes)
            throws ExportException {
        ...
        final Fragment xmlDefaultFragment = xmlFragmentMap
                .remove(fr.cnes.regards.modules.dam.domain.models.attributes.Fragment.getDefaultName());
    ...
    private static void dispatchAttribute(Map<String, Fragment> fragmentMap, ModelAttrAssoc modelAttrAssoc) {
        ...
        final fr.cnes.regards.modules.dam.domain.models.attributes.Fragment fragment = attModel.getFragment();
    ...
    /**
     * Build a {@link Fragment} based on a {@link fr.cnes.regards.modules.dam.domain.models.attributes.Fragment} and its
     * related {@link AttributeModel}
     * @param fragment {@link fr.cnes.regards.modules.dam.domain.models.attributes.Fragment}
     * @param attributes list of {@link AttributeModel}
     * @return {@link Fragment}
     */
    private static Fragment toXmlFragment(fr.cnes.regards.modules.dam.domain.models.attributes.Fragment fragment,
