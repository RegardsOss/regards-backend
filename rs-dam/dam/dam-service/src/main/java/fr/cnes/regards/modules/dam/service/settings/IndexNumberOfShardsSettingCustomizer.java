...
@Component
public class IndexNumberOfShardsSettingCustomizer extends AbstractSimpleDynamicSettingCustomizer {

    public IndexNumberOfShardsSettingCustomizer() {
        super(DamSettings.INDEX_NUMBER_OF_SHARDS, "parameter [number of shards] can be null or must be a valid number");
    }
