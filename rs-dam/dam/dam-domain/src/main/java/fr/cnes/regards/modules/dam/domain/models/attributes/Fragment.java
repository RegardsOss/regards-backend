...
public class Fragment
        implements IIdentifiable<Long>, IXmlisable<fr.cnes.regards.modules.dam.domain.models.schema.Fragment> {
    ...
    @Override
    public fr.cnes.regards.modules.dam.domain.models.schema.Fragment toXml() {

        // CHECKSTYLE:OFF
        final fr.cnes.regards.modules.dam.domain.models.schema.Fragment xmlFragment = new fr.cnes.regards.modules.dam.domain.models.schema.Fragment();
        // CHECKSTYLE:ON
    ...
    @Override
    public void fromXml(fr.cnes.regards.modules.dam.domain.models.schema.Fragment pXmlElement) {
