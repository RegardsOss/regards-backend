 ...
 */
package fr.cnes.regards.modules.dam.domain.models;
...
public class Model implements IIdentifiable<Long>, IXmlisable<fr.cnes.regards.modules.dam.domain.models.schema.Model> {
    ...
    @Override
    public fr.cnes.regards.modules.dam.domain.models.schema.Model toXml() {
        final fr.cnes.regards.modules.dam.domain.models.schema.Model xmlModel = new fr.cnes.regards.modules.dam.domain.models.schema.Model();
    ...
    @Override
    public void fromXml(fr.cnes.regards.modules.dam.domain.models.schema.Model pXmlElement) {
