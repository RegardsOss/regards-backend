...
public class DBConnectionControllerIT extends AbstractRegardsTransactionalIT {
    ...
    public void createPostgresDBConnection() throws ModuleException {
        ...
        performDefaultPost(DBConnectionController.TYPE_MAPPING,
                           readJsonContract("newConnection.json"),
                           customizer,
        ...
        performDefaultPut(DBConnectionController.TYPE_MAPPING + "/{connectionId}",
                          dbConf,
                          customizer,
                          "Configuration should be saved!",
                          dbConf.getId());
    ...
    public void getDBConnection() throws ModuleException {
        ...
        performDefaultGet(DBConnectionController.TYPE_MAPPING + "/{connectionId}",
                          expectations,
                          "Could not get a DBConnection.",
                          plgConf.getId());
    }
    ...
    public void getUnknownDBConnection() throws ModuleException {
        ...
        performDefaultGet(DBConnectionController.TYPE_MAPPING + "/{connectionId}",
                          expectations,
                          "Could not get an unknown DBConnection.",
                          plgConf.getId() + 1000);
    }
    ...
    public void deleteDBConnection() throws ModuleException {
        ...
        performDefaultDelete(DBConnectionController.TYPE_MAPPING + "/{connectionId}",
                             expectations,
                             "Could not delete a DBConnection.",
                             plgConf.getId());
    ...
    public void testConnection() throws ModuleException {
        ...
        performDefaultPost(DBConnectionController.TYPE_MAPPING + "/{connectionId}",
                           dbConnection,
                           expectations,
                           "The DBConnection is not valid.",
                           dbConnection.getId());
    }
    ...
    public void getTables() throws ModuleException {
        ...
        performDefaultGet(DBConnectionController.TYPE_MAPPING + "/{connectionId}/tables",
                          expectations,
