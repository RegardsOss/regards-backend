/* Data Accesses */
create table t_access_group (id int8 not null, public boolean, name varchar(32), primary key (id));
create table t_access_right (id int8 not null, access_level varchar(30), data_access_level varchar(30), max_score int4, min_score int4, quality_level varchar(30), access_group_id int8, plugin_conf_id int8, dataset_id int8, primary key (id));
