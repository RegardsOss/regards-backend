...
import fr.cnes.regards.modules.dataset.service.GreetingsService;
 ...
 */
@RestController
@ModuleInfo(name="dataset", version="1.0-SNAPSHOT", author="REGARDS", legalOwner="CS", documentation="http://test")
@RequestMapping("/api")
