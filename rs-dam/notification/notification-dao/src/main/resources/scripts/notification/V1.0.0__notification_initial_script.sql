create table t_rule (id int8 not null, type varchar(30) not null, plugin_configuration_id int8 not null, enable boolean not null, primary key (id));
...
create table t_recipient (id int8 not null, rule_id int8, plugin_configuration_id int8 not null, primary key (id));
