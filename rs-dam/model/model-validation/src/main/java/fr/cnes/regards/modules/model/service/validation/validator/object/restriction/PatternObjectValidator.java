...
import fr.cnes.regards.modules.model.service.validation.validator.common.restriction.AbstractPatternValidator;

import java.util.List;

/**
 * Validates a String against a Pattern with a {@link PatternRestriction}
 *
 * @author Thibaud Michaudel
 **/
public class PatternObjectValidator extends AbstractPatternValidator {

    public PatternObjectValidator(PatternRestriction pRestriction, String pAttributeKey) {
    ...
    protected String[] getStringArrayValue(Object pTarget) {
        return ((List<String>) pTarget).toArray(new String[((List<String>) pTarget).size()]);
    }
