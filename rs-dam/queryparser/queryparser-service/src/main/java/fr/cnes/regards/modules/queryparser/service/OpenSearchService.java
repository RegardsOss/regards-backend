...
import fr.cnes.regards.modules.queryparser.service.geoparser.GeoParser;
...
public class OpenSearchService implements IOpenSearchService {
     ...
     */
    public OpenSearchService(@Autowired RegardsQueryParser pQueryParser, @Autowired GeoParser pGeoParser) {
        super();
