create table t_feature (id int8 not null, urn varchar(132), session_owner varchar(128) NOT NULL, session_name varchar(128) NOT NULL, feature jsonb, last_update timestamp not null, state varchar(50) not null, provider_id varchar(100) not null, version numeric not null,primary key (id));
