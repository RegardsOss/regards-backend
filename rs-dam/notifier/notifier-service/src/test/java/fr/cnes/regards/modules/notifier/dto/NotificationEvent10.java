...
public class NotificationEvent10 implements ISubscribable {
    ...
    public static NotificationEvent10 build(JsonElement element, NotificationManagementAction action) {
        NotificationEvent10 toCreate = new NotificationEvent10();
