...
public class NotificationEvent8 implements ISubscribable {
    ...
    public static NotificationEvent8 build(JsonElement element, NotificationManagementAction action) {
        NotificationEvent8 toCreate = new NotificationEvent8();
