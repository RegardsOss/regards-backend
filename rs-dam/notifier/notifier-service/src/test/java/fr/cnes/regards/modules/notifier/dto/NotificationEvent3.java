...
public class NotificationEvent3 implements ISubscribable {
    ...
    public static NotificationEvent3 build(JsonElement element, NotificationManagementAction action) {
        NotificationEvent3 toCreate = new NotificationEvent3();
