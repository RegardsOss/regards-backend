...
public class GeometryIT implements InitializingBean {
    ...
    public void testOnDbMultiPointLineString() throws ModuleException {
        ...
        LineString lineString = IGeometry.lineString(IGeometry.toLineStringCoordinates(IGeometry.position(41.12,
                                                                                                          -71.34),
    ...
    public void testOnDbMultiLineStringPolygon() throws ModuleException {
        ...
        // Setting a geometry onto collection
        collection = new Collection(collectionModel, TENANT, "COL1", "collection with geometry");
        MultiLineString geometry = IGeometry.multiLineString(IGeometry.toLineStringCoordinates(IGeometry.position(41.12,
                                                                                                                  -71.34),
                                                                                               IGeometry.position(42.,
                                                                                                                  -72.)),
                                                             IGeometry.toLineStringCoordinates(IGeometry.position(39.12,
                                                                                                                  -70.34),
                                                                                               IGeometry.position(38.,
                                                                                                                  -70.)));
    ...
    public void testOnEsMultiLineStringPolygon() {
        // Setting a geometry onto collection
        collection = new Collection(collectionModel, TENANT, "COL1", "collection with geometry");
        collection.setNormalizedGeometry(IGeometry.multiLineString(IGeometry.toLineStringCoordinates(IGeometry.position(
                                                                       41.12,
                                                                       -71.34), IGeometry.position(42., -72.)),
                                                                   IGeometry.toLineStringCoordinates(IGeometry.position(
                                                                       39.12,
                                                                       -70.34), IGeometry.position(38., -70.))));
        esRepos.save(TENANT, collection);
        esRepos.refresh(TENANT);
        ...
        Polygon polygon = IGeometry.polygon(IGeometry.toPolygonCoordinates(IGeometry.toLinearRingCoordinates(IGeometry.position(
                                                                                                                 1.4522552490234373,
                                                                                                                 43.62365009386727),
                                                                                                             IGeometry.position(
                                                                                                                 1.4556884765625,
                                                                                                             ...
                                                                                                             IGeometry.position(
                                                                                                                 1.4522552490234373,
                                                                                                                 43.62365009386727)),
                                                                           IGeometry.toLinearRingCoordinates(IGeometry.position(
                                                                                                                 1.47216796875,
                                                                                                                 43.608736628843445),
                                                                                                             IGeometry.position(
                                                                                                                 1.4728546142578125,
    ...
    public void testOnDbMultiPolygon() throws ModuleException {
        ...
        MultiPolygon mp = IGeometry.multiPolygon(IGeometry.toPolygonCoordinates(IGeometry.toLinearRingCoordinates(
                                                     ...
                                                     IGeometry.position(103.0, 2.0),
                                                     IGeometry.position(103.0, 3.0),
                                                     IGeometry.position(102.0, 3.0),
                                                     IGeometry.position(102.0, 2.0))),
                                                 IGeometry.toPolygonCoordinates(IGeometry.toLinearRingCoordinates(
    ...
    public void testDepartement() {
        IGeometry polygon = IGeometry.simpleClockwisePolygon(-0.10212095637964737,
                                                             47.064797190818005,
                                                             -0.09805549141019346,
                                                             47.0913509263054,
                                                             -0.08590400471278307,
                                                             ...
                                                             0.02069664723879619,
                                                             46.38800352143432,
                                                             2.6572855997630953E-4,
                                                             46.392018635848565,
                                                             -0.017092824348942416,
                                                             46.4113223945137,
                                                             -0.010457661947033809,
                                                             46.44881280383021,
                                                             -0.01707071907246923,
                                                             46.47527516260208,
                                                             -0.04230359002464692,
                                                             ...
                                                             -0.03135125528751674,
                                                             46.52498101941566,
                                                             -0.007157529433821307,
                                                             46.52327699327565,
                                                             0.007895566679664658,
                                                             46.547974321223606,
                                                             -0.008022109474557896,
                                                             46.567543137522954,
                                                             0.020058959008376207,
                                                             46.58512799711242,
                                                             0.022854639746489266,
                                                             46.614530685176334,
                                                             0.0031057671136598976,
                                                             46.61079878720693,
                                                             -0.026547974206768066,
                                                             46.62886079422371,
                                                             -0.0653244004897615,
                                                             46.63246151135352,
                                                             -0.03338532562574275,
                                                             46.65364917507512,
                                                             -0.040426190194721524,
                                                             46.66371702380725,
                                                             -0.006947998344661607,
                                                             46.68290982229758,
                                                             7.042720140891931E-4,
                                                             46.71623331657764,
                                                             0.03826535834799053,
                                                             46.73158052408886,
                                                             0.005731121087621784,
                                                             46.75454225312974,
                                                             -0.014979708609133745,
                                                             46.75637013577674,
                                                             -0.02232550667364259,
                                                             46.78961529950765,
                                                             -0.020316336069380297,
                                                             46.812653925006536,
                                                             -0.04568987388716529,
                                                             46.83210506753766,
                                                             -0.007773096486773423,
                                                             46.84747452695961,
                                                             0.01660746491547145,
                                                             46.83496346394018,
                                                             0.02561539858266648,
                                                             46.85287480114874,
                                                             -0.027263869318720418,
                                                             46.87992322868147,
                                                             -0.009032410299882686,
                                                             46.90747700605923,
                                                             -0.022215929347250134,
                                                             46.938478291692846,
                                                             -0.044186809693518486,
                                                             46.95837119466449,
                                                             -0.038153345460296736,
                                                             46.98939008519809,
                                                             -0.06675773993609899,
                                                             46.99387700352016,
                                                             -0.08113082448484565,
    ...
    public void testConstellation() {
        ...
        IGeometry polygon = IGeometry.simplePolygon(1.5334,
                                                    -81.804,
                                                    1.5663,
                                                    -74.304,
                                                    -8.0022,
