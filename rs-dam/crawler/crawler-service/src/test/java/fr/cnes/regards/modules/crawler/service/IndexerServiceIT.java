...
public class IndexerServiceIT {
    ...
    public void test() throws IOException {
        ...
        String key = "booleanAtt";
        gsonAttributeFactory.registerSubtype(BooleanAttribute.class, key);
        attributes.add(AttributeBuilder.buildBoolean(key, true));
        ...
        String fragmentName = "correspondance";
        gsonAttributeFactory.registerSubtype(ObjectAttribute.class, fragmentName);
        String stringArrayMusset = "stringArrayMusset";
        gsonAttributeFactory.registerSubtype(StringArrayAttribute.class, stringArrayMusset, fragmentName);
        String stringArraySand = "stringArraySand";
        gsonAttributeFactory.registerSubtype(StringArrayAttribute.class, stringArraySand, fragmentName);

        ObjectAttribute fragment = AttributeBuilder
                .buildObject(fragmentName,
