...
/**
 * Handler for {@link fr.cnes.regards.modules.dam.domain.dataaccess.accessright.event.AccessRightEvent}
 ...
 **/
@Component
public class AccessRightEventHandler
    implements ApplicationListener<ApplicationReadyEvent>, IBatchHandler<AccessRightEvent> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AccessRightEventHandler.class);
    ...
    public AccessRightEventHandler(ISubscriber subscriber, EntityIndexerService entityIndexerService) {
    ...
    @Override
    public void handleBatch(List<AccessRightEvent> messages) {
        ...
        List<EntityEventRequest> entityRequests = messages.stream()
                                                          .map(event -> new EntityEventRequest(event.getDatasetIpId()
                                                                                                    .toString(), null,
    ...
    @Override
    public Errors validate(AccessRightEvent message) {
        return null;
    }
