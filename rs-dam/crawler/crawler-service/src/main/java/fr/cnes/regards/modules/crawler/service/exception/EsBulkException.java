 ...
 * @author tguillou
 */
public class EsBulkException extends ModuleException {

    public EsBulkException() {
        super("Some errors were detected during the bulk save operation in Elasticsearch.");
    }
}
