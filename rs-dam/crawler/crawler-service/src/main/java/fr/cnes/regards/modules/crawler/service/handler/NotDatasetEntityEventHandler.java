...
/**
 * Handler for {@link NotDatasetEntityEvent} (Entity event for collections).
 ...
 **/
@Service
public class NotDatasetEntityEventHandler
    implements ApplicationListener<ApplicationReadyEvent>, IBatchHandler<NotDatasetEntityEvent> {

    private static final Logger LOGGER = LoggerFactory.getLogger(NotDatasetEntityEventHandler.class);
    ...
    public NotDatasetEntityEventHandler(ISubscriber subscriber, EntityIndexerService entityIndexerService) {
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        subscriber.subscribeTo(NotDatasetEntityEvent.class, this);
    }

    @Override
    public void handleBatch(List<NotDatasetEntityEvent> messages) {
        LOGGER.debug("[NotDatasetEntityEvent HANDLER {} messages received ] ", messages.size());
        ...
        LOGGER.info("[NotDatasetEntityEvent HANDLER] {} messages handled in {} ms",
                    messages.size(),
    ...
    @Override
    public Errors validate(NotDatasetEntityEvent message) {
        return null;
    }
