...
public class AttrDescToJsonMappingTest {
    ...
    @Test public void toJsonMapping() {
    ...
    @Test public void nestedPropertiesStructure() {
        String innerStr = "{\"type\":\"number\"}";
        JsonObject innermost = new JsonParser().parse(innerStr).getAsJsonObject();

        JsonObject jsonObject = AttrDescToJsonMapping
                .nestedPropertiesStructure("high.medium.low", innermost);
    ...
    @Test public void toJsonMappingDateIntervalWithAlias() {
        // GIVEN
