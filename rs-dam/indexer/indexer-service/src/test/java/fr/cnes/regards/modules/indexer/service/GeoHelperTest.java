...
public class GeoHelperTest {
    ...
    public void testSanitizePolygoneIssueThor() {
        double[][][] polygonFailingOnThor = new double[][][] { { { -146.33, 74.64 },
                                                                 { -91.35, 66.92 },
                                                                 { -89.32, 65.97 },
                                                                 { -87.43, 65.03 },
                                                                 { -85.61, 64.08 },
    ...
    public void testSomeInvalidAdeoFeature() {
        ...
        double[][][] polygonThatShouldBeSplitted = new double[][][] { { { -62.14, -68.97 },
                                                                        { -64.12, -52.14 },
                                                                        { -64.1, -50.92 },
                                                                        { -64.0, -49.81 },
                                                                        { -63.91, -48.69 },
    ...
    public void testValidAdeoFeature() {
        ...
        double[][][] polygonThatShouldBeSplitted = new double[][][] { { { -176.8, -55.64 },
                                                                        { 146.66, -50.03 },
                                                                        { 155.8, -34.64 },
                                                                        { 156.36, -33.58 },
                                                                        { 156.82, -32.58 },
    ...
    public void testStrangeAdeoFeature() {
        double[][][] polygonThatShouldBeSplitted = new double[][][] { { { -94.75, -57.86 },
                                                                        { -94.89, -40.97 },
                                                                        { -94.77, -39.81 },
                                                                        { -94.63, -38.69 },
                                                                        { -94.45, -37.58 },
