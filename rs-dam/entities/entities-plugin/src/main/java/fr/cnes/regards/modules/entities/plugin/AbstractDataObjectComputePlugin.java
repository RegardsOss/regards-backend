    ...
    protected void init(String attributeToComputeName, String attributeToComputeFragmentName,
        ...
        if (attributeToCompute == null) {
            if (attributeToComputeFragmentName != null) {
                ...
                throw new EntityNotFoundException(String.format("Cannot find computed attribute '%s'", attributeToComputeName));
            }
        }
        ...
        if (parameterAttribute == null) {
            if (parameterAttributeFragmentName != null) {
                ...
                throw new EntityNotFoundException(String.format("Cannot find parameter attribute '%s'", parameterAttributeName));
            }
        }
