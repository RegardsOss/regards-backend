 ...
 */
package fr.cnes.regards.modules.entities.domain.json;
...
public class JsonTypeDescriptor extends AbstractTypeDescriptor<Object> implements DynamicParameterizedType {
    ...
    public boolean areEqual(Object one, Object another) {
        ...
        return GsonUtil.toJsonNode(GsonUtil.toString(one))
                .equals(GsonUtil.toJsonNode(GsonUtil.toString(another)));
    }
