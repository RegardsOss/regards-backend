 ...
 *
 */
public class KVPSerializationTest {

    /**
     * Class logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(KVPSerializationTest.class);
     ...
     * Polymorphic factory
     */
    private KVPAdapterFactory factory;
    ...
    public void initGson() {
        ...
        TestEntityTypeAdapterFactory entityFactory = new TestEntityTypeAdapterFactory();
        gsonBuilder.registerTypeAdapterFactory(entityFactory);

        factory = new KVPAdapterFactory();
