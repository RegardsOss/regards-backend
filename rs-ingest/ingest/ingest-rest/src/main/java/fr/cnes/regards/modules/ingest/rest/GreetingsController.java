...
import fr.cnes.regards.modules.ingest.service.GreetingsService;
 ...
 */
@RestController
@ModuleInfo(name="ingest-rest", version="2.0.0-SNAPSHOT", author="REGARDS", legalOwner="CS", documentation="http://test")
@RequestMapping("/api")
