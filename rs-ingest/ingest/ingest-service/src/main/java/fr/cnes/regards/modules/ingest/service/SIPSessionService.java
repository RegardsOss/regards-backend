...
public class SIPSessionService implements ISIPSessionService {
    ...
    public void retryAipGeneration(String id) {
        sipRepository.updateSIPEntityStateByStateAndSession(SIPState.CREATED, SIPState.AIP_GEN_ERROR,
