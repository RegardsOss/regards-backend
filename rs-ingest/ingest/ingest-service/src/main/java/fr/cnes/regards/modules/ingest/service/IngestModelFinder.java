 ...
 **/
@Service
public class IngestModelFinder extends AbstractCacheableModelFinder implements IModelFinder {

    private static final Logger LOGGER = LoggerFactory.getLogger(IngestModelFinder.class);
