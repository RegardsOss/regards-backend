 ...
 * @author Marc Sordi
 */
@Plugin(author = "REGARDS Team", description = "Test plugin with parameters", id = "SipValidationWithParameters",
        version = "1.0.0", contact = "regards@c-s.fr", licence = "GPLv3", owner = "CNES",
        url = "https://regardsoss.github.io/")
public class SipValidationWithParameters implements ISipValidation {

    @PluginParameter(name = "testParameter", description = "Test parameter")
