 ...
 **/
public interface IAipDisseminationRequestRepository extends JpaRepository<AipDisseminationRequest, Long> {

    default Page<AipDisseminationRequest> findWaitingRequest(Pageable pageRequest) {
        return findAllByState(InternalRequestState.CREATED, pageRequest);
    }

    Page<AipDisseminationRequest> findAllByState(InternalRequestState step, Pageable page);
