...
ALTER TABLE t_sip ADD CONSTRAINT uk_sip_provider_id_last unique (last,provider_id);
...
ALTER TABLE t_aip ADD CONSTRAINT uk_aip_provider_id_last unique (last,provider_id);