...
-- Ingest request
create table t_ingest_request (id int8 not null, request_id varchar(36) NOT NULL, ingest_chain varchar(100) not null, session_name varchar(128) not null, session_owner varchar(128) not null, storages jsonb, state varchar(20) NOT NULL, errors jsonb, rawsip jsonb, job_info_id uuid, categories jsonb, step varchar(50) NOT NULL, remote_step_deadline TIMESTAMP, remote_step_group_id varchar(36), state varchar(50) NOT NULL, errors jsonb, rawsip jsonb, job_info_id uuid, primary key (id));
