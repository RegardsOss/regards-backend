...
create table t_dump_settings (id int8 not null, active_module boolean not null, cron_trigger varchar(1000) not null, dump_location varchar(260), last_dump_req_date timestamp);
alter table t_dump_settings add constraint uk_t_dump_settings unique (id);
