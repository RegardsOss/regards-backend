...
@TestPropertySource(properties = { "spring.jpa.properties.hibernate.default_schema=file_catalog_reference_tests" },
                    locations = { "classpath:application-test.properties" })
public class FileReferenceServiceIT extends AbstractFileCatalogIT {
    ...
    public void search() throws InterruptedException {
        ...
        Assert.assertEquals("There should be 5 file references.",
                            5,
                            fileReferenceService.search(PageRequest.of(0, 100, Direction.ASC, "id"))
                                                .getTotalElements());
        // Search by fileName
        ...
        Assert.assertEquals("There should be one file references named file1.test.",
                            1,
                            fileReferenceService.search(FileReferenceSpecification.search("file1.test",
                                                                                          null,
                                                                                          null,
                                                                                          null,
                                                                                          null,
        ...
        Assert.assertEquals("There should be 3 file references with name containing file",
                            3,
                            fileReferenceService.search(FileReferenceSpecification.search("file",
                                                                                          null,
                                                                                          null,
                                                                                          null,
                                                                                          null,
        ...
        Assert.assertEquals("There should be one file references with checksum given",
                            1,
                            fileReferenceService.search(FileReferenceSpecification.search(null,
                                                                                          fileRef.getMetaInfo()
                                                                                                 .getChecksum(),
                                                                                          null,
                                                                                          null,
