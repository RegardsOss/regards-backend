...
public class UsersControllerIT extends RegardsIntegrationTest {
    ...
    public void cGetUserPermissions() {
        ...
        //
        // assertFalse(!this.serviceStub.existUser(userId));
        // ParameterizedTypeReference<Couple<List<ResourcesAccess>, Role>> typeRef = new
        // ParameterizedTypeReference<Couple<List<ResourcesAccess>, Role>>() {
        // };
        ...
        // assertEquals(HttpStatus.OK, response.getStatusCode());
        //
        // ResponseEntity<Object> responseNotFound = restTemplate.exchange(this.apiUserPermissions, HttpMethod.GET,
        // null,
        // Object.class, Integer.MAX_VALUE);
        // assertEquals(HttpStatus.NOT_FOUND, responseNotFound.getStatusCode());
        //
    ...
    public void dUpdateUserPermissions() {
        ...
        // ResponseEntity<Void> response = restTemplate.exchange(this.apiUserPermissions, HttpMethod.PUT, request,
        // typeRef,
        // userId);
        //
        // assertEquals(HttpStatus.OK, response.getStatusCode());
    ...
    public void dDeleteUserPermissions() {
        ...
        // };
        //
        // ResponseEntity<Void> response = restTemplate.exchange(this.apiUserPermissions, HttpMethod.DELETE, null,
        // typeRef,
        // userId);
        // assertEquals(HttpStatus.OK, response.getStatusCode());
    }
    ...
    public void dUpdateUser() {
        ...
        // ResponseEntity<Void> response = restTemplate.exchange(this.apiUserId, HttpMethod.PUT, request, typeRef,
        // userId);
    ...
    public void eDeleteUser() {
        ...
        // ParameterizedTypeReference<Void> typeRef = new ParameterizedTypeReference<Void>() {
        // };
        // ResponseEntity<Void> response = restTemplate.exchange(this.apiUserId, HttpMethod.DELETE, null, typeRef,
        // userId);
        // assertEquals(HttpStatus.OK, response.getStatusCode());
    }
}
