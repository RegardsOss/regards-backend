...
public class NotificationUserSetting {
     ...
     * @param pProjectUser  One of the notification's recipients
     * @param pSettings     The recipient's settings
     */
    public NotificationUserSetting(final Notification pNotification,
                                   final String pProjectUser,
