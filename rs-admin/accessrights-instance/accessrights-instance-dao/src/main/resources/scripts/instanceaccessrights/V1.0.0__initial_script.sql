create table t_account (id int8 not null, status type varchar(20), authentication_failed_counter int8, email varchar(100), external boolean, firstName varchar(100), invalidityDate timestamp, lastName varchar(100), password varchar(200), password_update_date timestamp, status varchar(10), primary key (id));
