...
public interface IPasswordResetService {
     ...
     * @return the token
     * @throws EntityNotFoundException if no {@link PasswordResetToken} with passed token could be found
     */
     ...
     *
     * @param pAccountEmail The {@link Account}'s <code>id</code>
     * @param pResetCode    The reset code. Required to allow a password change
     * @param pNewPassword  The new <code>password</code>
