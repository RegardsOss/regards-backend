 ...
 */
package fr.cnes.regards.microservices.rest;
...
import fr.cnes.regards.microservices.domain.Greeting;
import fr.cnes.regards.microservices.service.GreetingsService;
 ...
 */
@RestController
@ModuleInfo(name="accessrights-instance-rest", version="2.0.0-SNAPSHOT", author="REGARDS", legalOwner="CS", documentation="http://test")
@RequestMapping("/api")
