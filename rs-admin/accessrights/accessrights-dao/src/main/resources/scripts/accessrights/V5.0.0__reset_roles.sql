...
DELETE from t_project_user where role_id in (select id from t_role where parent_role_id in (select id from t_role where name = 'ADMIN'));
DELETE from ta_resource_role; 
DELETE from t_project_user where role_id in (select id from t_role where name = 'ADMIN');
DELETE from t_role where parent_role_id in (select id from t_role where name = 'ADMIN');
