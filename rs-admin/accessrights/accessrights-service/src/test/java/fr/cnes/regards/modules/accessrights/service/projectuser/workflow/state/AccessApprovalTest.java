...
public class AccessApprovalTest extends UserAccessUpdateTest {
    ...
    public void publish_user_access_update() throws Exception {
        ProjectUser givenUser = UserBuilder.aUser().unauthorized().build();
        userWorkflowManager.grantAccess(givenUser);
        assertThat(publishedEvent()).isNotNull();
        assertThat(publishedEvent()).isInstanceOf(OnGrantAccessEvent.class);
    }
