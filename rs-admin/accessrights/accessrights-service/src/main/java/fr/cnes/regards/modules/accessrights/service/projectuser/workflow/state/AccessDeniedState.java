...
public class AccessDeniedState extends AbstractDeletableState {
    ...
    public AccessDeniedState(IProjectUserRepository projectUserRepository, IEmailVerificationTokenService emailVerificationTokenService, IPublisher publisher,
