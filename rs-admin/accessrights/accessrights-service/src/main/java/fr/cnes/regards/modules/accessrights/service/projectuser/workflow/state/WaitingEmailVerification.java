...
public class WaitingEmailVerification extends AbstractDeletableState {
    ...
    public WaitingEmailVerification(IProjectUserRepository projectUserRepository, IEmailVerificationTokenService emailVerificationTokenService, IPublisher publisher,
    ...
    /* (non-Javadoc)
     * @see fr.cnes.regards.modules.accessrights.service.projectuser.workflow.state.AbstractProjectUserState#verifyEmail(fr.cnes.regards.modules.accessrights.domain
