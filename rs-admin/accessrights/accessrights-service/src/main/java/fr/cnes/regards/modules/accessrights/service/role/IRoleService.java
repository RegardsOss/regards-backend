...
public interface IRoleService {
     ...
     *
     * @param pRoleName role name to retrieve
     ...
     *
     * @param pRoleName    The {@link Role} <code>name</code>
     ...
     *
     * @param pRoleId The {@link Role}'s <code>id</code>
     * @throws EntityException If role doesn't exists or when the updated role is native. Native roles should not be removed
     */
     ...
     *
     * @param pRoleId            The {@link Role}'s <code>id</code>
     * @param pResourcesAccesses The {@link List} of {@link ResourcesAccess} to set
     * @return The updated {@link Role}
     * @throws EntityNotFoundException Thrown when no {@link Role} with passed <code>id</code> could be found
     ...
     *
     * @param pRoleId The {@link Role} <code>id</code>
     * @throws EntityNotFoundException Thrown when no {@link Role} with passed <code>id</code> could be found
     */
     ...
     *
     * @param roleName  The {@link Role}'s <code>id</code>
     * @param pPageable the paging information
     * @return The {@link List} of {@link ProjectUser} for the {@link Role}
     * @throws EntityNotFoundException Thrown when no {@link Role} with passed <code>id</code> could be found
     */
     ...
     *
     * @param pName The {@link Role}'s name
     * @return True if the role exists, else false
     */
     ...
     * ADMIN.
     *
     * @param pRole role to retrieve inherited roles
