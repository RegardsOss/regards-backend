...
import fr.cnes.regards.modules.access.services.domain.Greeting;
import fr.cnes.regards.modules.access.services.service.GreetingsService;
 ...
 */
@RestController
@ModuleInfo(name="access-services-rest", version="1.1.0-SNAPSHOT", author="REGARDS", legalOwner="CS", documentation="http://test")
@RequestMapping("/api")
