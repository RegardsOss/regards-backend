...
public class StorageRestClientMock implements IStorageRestClient {
    ...
    public static final long DEFAULT_QUOTA_LIMITS_STUB_MAX_QUOTA = random.nextInt(10_000);
    public static final long DEFAULT_QUOTA_LIMITS_STUB_RATE_LIMIT = random.nextInt(10_000);
    public static final DefaultDownloadQuotaLimits DEFAULT_QUOTA_LIMITS_STUB = new DefaultDownloadQuotaLimits(
    ...
    public ResponseEntity<DefaultDownloadQuotaLimits> changeDefaultDownloadQuotaLimits(@Valid DefaultDownloadQuotaLimits newDefaults) {
        return new ResponseEntity<>(newDefaults, HttpStatus.OK);
    }
