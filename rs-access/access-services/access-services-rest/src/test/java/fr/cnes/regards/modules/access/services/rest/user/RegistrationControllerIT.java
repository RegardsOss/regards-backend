...
public class RegistrationControllerIT extends AbstractRegardsTransactionalIT {
    ...
    public void requestAccess() {
        ...
        performDefaultPost(RegistrationController.REQUEST_MAPPING_ROOT, ACCESS_REQUEST_STUB, customizer, "Failed to request access");
    }
    ...
    public void requestExternalAccess() {
        ...
        performDefaultPost(RegistrationController.REQUEST_MAPPING_ROOT, ACCESS_REQUEST_STUB, customizer, "Failed to request external access");
    }
