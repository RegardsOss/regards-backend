...
import fr.cs.regards.services.rest.authentication.ResourceServerConfigurer;
...
@WebIntegrationTest
public abstract class RegardsIntegrationTests {

    private static final Logger LOGGER = LoggerFactory.getLogger(RegardsIntegrationTests.class);
    ...
    protected String getLegacyEndpoint() {
        return String.format(BASE_URL_TEMPLATE, port_ + URL_SEPARATOR
                             + ResourceServerConfigurer.REST_LEGACY_API_MAPPING);
    }
    ...
    private String getBearerToken(String pClient, String pClientSecret, String pUsername, String pPassword,
        ...
        final RestTemplate restTemplate = new TestRestTemplate(pClient, pClientSecret);
        ...
        final ResponseEntity<OAuth2AccessToken> response = restTemplate.postForEntity(getOAuth2TokenEndpoint(),
                                                                                      bodyMap, OAuth2AccessToken.class);
     ...
     * @since 1.0-SNAPSHOT
     */
    protected RestTemplate buildOauth2RestTemplate(String pUsername, String pPassword) {
     ...
     * @since 1.0-SNAPSHOT
     */
    protected RestTemplate buildOauth2RestTemplate(String pUsername, String pPassword, String pScope) {
     ...
     * @since 1.0-SNAPSHOT
     */
    protected RestTemplate buildOauth2RestTemplate(String pClient, String pClientSecret, String pUsername,
