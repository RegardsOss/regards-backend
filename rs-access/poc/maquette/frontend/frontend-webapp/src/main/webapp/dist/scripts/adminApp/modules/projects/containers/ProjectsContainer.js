...
class ProjectsContainer extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("fieldset", {className: className}, React.createElement("legend", null, "Projects"), React.createElement(ProjectConfigurationComponent_1.default, {styles: this.props.styles, show: this.props.projectConfigurationIsShown, handleSubmit: this.props.handleSubmit, onCancelClick: this.props.hideProjectConfiguration, submitting: true}), React.createElement(ManageProjectsComponent_1.default, {styles: this.props.styles, projects: this.props.projects, selectedProjectId: this.props.selectedProjectId, onSelect: this.props.onSelect, onAddClick: this.props.showProjectConfiguration, onDeleteClick: this.props.deleteProject}), React.createElement(projectAdmins_1.ProjectAdminsContainer, null)));
    }
}
