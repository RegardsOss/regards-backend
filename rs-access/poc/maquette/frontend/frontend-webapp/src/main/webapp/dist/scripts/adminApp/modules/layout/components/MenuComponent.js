...
class Menu extends React.Component {
    render() {
        ...
        return (React.createElement("div", {className: menuClassName}, 
            React.createElement("ul", {className: ulClassName}, 
                React.createElement("li", null, 
                    React.createElement(MenuButtonComponent_1.default, {to: "/admin/" + project + "/test", styles: styles, label: "Logout", icon: "fi-power"})
                ), 
                React.createElement("li", null, 
                    React.createElement(MenuButtonComponent_1.default, {to: "/admin/" + project + "/projects", styles: styles, label: "Projects", icon: "fi-widget"})
                ))
        ));
    }
}
