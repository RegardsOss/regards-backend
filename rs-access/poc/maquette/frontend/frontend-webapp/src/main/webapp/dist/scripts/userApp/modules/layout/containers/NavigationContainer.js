...
class NavigationContainer extends AccessRightsComponent_1.default {
    ...
    render() {
        ...
        if (this.state.access === true && plugins.items) {
            return (React.createElement("nav", null, React.createElement(LinkComponent_1.default, {location: location, key: "plop", to: "/user/" + project + "/test"}, "Test de lien"), React.createElement(LinkComponent_1.default, {location: location, key: "time", to: "/user/" + project + "/time"}, "Temps"), plugins.items.map(plugin => {
