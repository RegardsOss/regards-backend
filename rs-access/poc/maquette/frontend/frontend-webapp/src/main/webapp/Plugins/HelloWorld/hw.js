...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RegardsPlugin = __webpack_require__(168);
	...
	(0, _RegardsPlugin.initRegardsPlugin)("HelloWorldPlugin", HelloWorldPlugin);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.initRegardsPlugin = undefined;

	var _reactRedux = __webpack_require__(169);

	var initRegardsPlugin = function initRegardsPlugin(pluginName, pluginClass) {
	  console.log("PLUGIN : send loaded event");
	  ...
	  var Plugin = (0, _reactRedux.connect)(mapStateToProps)(pluginClass);
	  var event = new CustomEvent('plugin', { detail: { name: pluginName, app: Plugin } });
	  document.dispatchEvent(event);
	};

	exports.initRegardsPlugin = initRegardsPlugin;
