...
function configureStore(preloadedState) {
    ...
    let win = window;
    const store = redux_1.createStore(rootReducer, preloadedState, redux_1.compose(redux_1.applyMiddleware(redux_thunk_1.default, ActionLoggerMiddleware_1.default, AuthorizationMiddleware_1.default, apiMiddleware), win["devToolsExtension"] ? win["devToolsExtension"]() : (f) => f));
    const render = () => {
