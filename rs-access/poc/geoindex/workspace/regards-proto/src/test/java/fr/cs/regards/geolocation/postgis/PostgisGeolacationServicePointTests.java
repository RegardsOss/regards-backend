...
public class PostgisGeolacationServicePointTests {
	...
	public void testPointInsideConcavePolyHole() throws Exception {
		Polygon researchPoly = new Polygon();
		Coordinate cp1 = new Coordinate(-20, 10);
		Coordinate cp2 = new Coordinate(-20, -20);
		Coordinate cp3 = new Coordinate(20, -20);
		Coordinate cp4 = new Coordinate(20, 10);
		Coordinate cp5 = new Coordinate(10, 10);
		Coordinate cp6 = new Coordinate(10, -10);
		Coordinate cp7 = new Coordinate(-10, -10);
		Coordinate cp8 = new Coordinate(-10, 10);
		//Coordinate cp9 = new Coordinate(-20, 10);
	...
	public static void main(String[] args) throws JsonProcessingException {
		...
		GDALUtils.insertObject("geomars", "test_point", 0, GeoJSONTools.createFeature(POINT_ID, polygon, "iau2000:49901"));
	}
