...
public class ElasticGeolacationServicePolygonTests {
	...
	private static String PG_CONN = String.format(PG_CONN_TPL, "geomars", "localhost", 5432, "postgres", "password");
	...
	public static void main(String[] args) throws JsonProcessingException {
		...
		GDALUtils.insertObject("geomars", TEST_INDEX, 1, GeoJSONTools.createFeature(POLYGON_ID, polygon, "uai2000:49901") );
	}
