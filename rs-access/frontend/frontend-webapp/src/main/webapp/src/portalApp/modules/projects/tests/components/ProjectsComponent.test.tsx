...
//       isFetching: false,
//       items: [
//         {name: 'cdpp', isPublic: true, description: "coucou", icon:""},
//         {name: 'ssalto', isPublic: true, description: "coucou", icon:""},
//       ],
//       lastUpdate: ''
//     }
//
...
//         <ul>
//           <ProjectComponent key="cdpp" project={{name: 'cdpp', isPublic: true, description: "coucou", icon:""}}/>
//           <ProjectComponent key="ssalto" project={{name: 'ssalto', isPublic: true, description: "coucou", icon:""}}/>
//         </ul>
//       </div>
//     );
//     const wrapper = shallow(<ProjectsContainer {...props}/>);
