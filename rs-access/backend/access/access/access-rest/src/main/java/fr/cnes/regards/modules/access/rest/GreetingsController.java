...
import fr.cnes.regards.modules.access.service.GreetingsService;
 ...
 */
@RestController
@ModuleInfo(name="access", version="1.0-SNAPSHOT", author="REGARDS", legalOwner="CS", documentation="http://test")
@RequestMapping("/api")
