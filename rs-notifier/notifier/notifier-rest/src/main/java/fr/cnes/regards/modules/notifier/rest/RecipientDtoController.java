 ...
 */
@RestController
@RequestMapping(RecipientDtoController.RECIPIENTS_PATH)
public class RecipientDtoController {
    ...
    public ResponseEntity<Set<RecipientDto>> findRecipients(
        @Parameter(description = "Recipient enable or not the direct notification", required = false)
        @RequestParam(required = false) Boolean directNotificationEnabled) {
