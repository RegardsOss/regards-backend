...
public class NotificationRequest {
    ...
    @JoinTable(name = "ta_notif_request_recipients_toschedule",
               ...
               indexes = { @Index(name = "idx_ta_notif_request_recipients_toschedule_recipient_id",
    ...
    @JoinTable(name = "ta_notif_request_recipients_scheduled",
               ...
               indexes = { @Index(name = "idx_ta_notif_request_recipients_scheduled_recipient_id",
                                  columnList = "recipient_id") })
    ...
    @JoinTable(name = "ta_notif_request_recipients_error",
               ...
               indexes = { @Index(name = "idx_ta_notif_request_recipients_error_recipient_id",
                                  columnList = "recipient_id") })
    ...
    @JoinTable(name = "ta_notif_request_recipients_success",
               ...
               inverseForeignKey = @ForeignKey(name = "fk_notification_request_recipients_success_id"),
               indexes = { @Index(name = "idx_ta_notif_request_recipients_success_recipient_id",
                                  columnList = "recipient_id") })
