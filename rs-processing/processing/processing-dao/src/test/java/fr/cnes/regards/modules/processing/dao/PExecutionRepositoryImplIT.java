...
public class PExecutionRepositoryImplIT extends AbstractRepoIT {
    ...
    public void test_count_executions() throws Exception {
        ...
        // WHEN
        List<PExecution> execs = domainExecRepo.findAllForMonitoringSearch(batch.getTenant(),
                                                                           null,
                                                                           null,
                                                                           singletonList(SUCCESS),
                                                                           nowUtc().minusHours(5),
                                                                           nowUtc().plusHours(5),
                                                                           PageRequest.of(0, 5)).collectList().block();
        ...
        Integer countRunning = domainExecRepo.countAllForMonitoringSearch(batch.getTenant(),
                                                                          batch.getProcessBusinessId().toString(),
                                                                          null,
        ...
        // WHEN
        List<PExecution> execRunningFirstPage = domainExecRepo.findAllForMonitoringSearch(batch.getTenant(),
        ...
        // WHEN
        List<PExecution> execRunningSecondPage = domainExecRepo.findAllForMonitoringSearch(batch.getTenant(),
                                                                                           null,
                                                                                           batch.getUserEmail(),
                                                                                           Arrays.asList(RUNNING,
                                                                                                         PREPARE,
