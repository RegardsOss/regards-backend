...
public class SubmissionCreateControllerIT extends AbstractRegardsIT {
    ...
    @Test
    public void test_api_doc_with_jackson() throws Exception {
        // GIVEN the OAS generated by jackson (see application-test.properties)
        ResultActions resultActions = performDefaultGet("/v3/api-docs", customizer().expectStatusOk(), "errorMsg");
        // WHEN I check the content of the OAS
        resultActions.andExpect(MockMvcResultMatchers.jsonPath("$.info.title").value("OpenAPI definition"));
    }
