 ...
 *
 */
@TestPropertySource(properties = { "regards.jpa.multitenant.migrationTool=HBM2DDL", "spring.jpa.properties.hibernate.default_schema=projectdb", "spring.application.name=storage" })
