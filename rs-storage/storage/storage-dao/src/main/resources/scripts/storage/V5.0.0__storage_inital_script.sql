...
create table t_request_result_info (id int8 not null, error boolean, error_cause varchar(512), group_id varchar(128) not null, request_checksum varchar(128) not null, request_storage varchar(128), request_store_path varchar(2048), request_type varchar(255) not null, request_owners jsonb, result_file_ref_id int8, primary key (id));
