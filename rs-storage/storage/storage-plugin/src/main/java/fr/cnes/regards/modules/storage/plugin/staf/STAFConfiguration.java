...
public class STAFConfiguration {
     ...
     * STAF Archives.
     */
    private List<STAFArchive> archives;
    ...
    public List<STAFArchive> getArchives() {
        return archives;
    }

    private STAFArchive getArchive(String pArchiveName) {
        Optional<STAFArchive> archive = archives.stream().filter(a -> pArchiveName.equals(a.getArchiveName()))
                .findFirst();
