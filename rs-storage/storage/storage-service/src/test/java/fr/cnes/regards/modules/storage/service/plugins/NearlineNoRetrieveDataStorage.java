 ...
 */
@Plugin(author = "REGARDS Team", description = "Fake plugin to test retrieval priority",
        id = "NearlineNoRetrieveDataStorage", version = "1.0", contact = "regards@c-s.fr", licence = "GPLv3",
...
public class NearlineNoRetrieveDataStorage implements INearlineDataStorage<LocalWorkingSubset> {
    ...
    public void retrieve(LocalWorkingSubset workingSubset, Path destinationPath, IProgressManager progressManager) {
        throw new IllegalStateException(
                "This plugin should be less prioritized than the \"real\" nearline data storage.");
    }
