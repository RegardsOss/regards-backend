...
public class UniformResourceName {
    ...
    public UniformResourceName(OAISIdentifier pOaisIdentifier, AipType pEntityType, String pTenant, UUID pEntityId,
            int pVersion) {
        super();
    ...
    public UniformResourceName(OAISIdentifier pOaisIdentifier, AipType pEntityType, String pTenant, UUID pEntityId, // NOSONAR
    ...
    public AipType getEntityType() {
        return entityType;
    }

    public void setEntityType(AipType pEntityType) {
        entityType = pEntityType;
    }
    ...
    public static UniformResourceName fromString(String pUrn) {
        ...
        final AipType entityType = AipType.valueOf(stringFragment[2]);
