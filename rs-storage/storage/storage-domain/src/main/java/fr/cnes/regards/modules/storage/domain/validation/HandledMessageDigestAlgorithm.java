package fr.cnes.regards.modules.storage.domain.validation;
...
public @interface HandledMessageDigestAlgorithm {
     ...
     * Class to validate
     */
    String CLASS_NAME = "fr.cnes.regards.modules.storage.domain.validation.HandledMessageDigestAlgorithm";
