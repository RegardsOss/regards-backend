...
public class UniformResourceNameTest {
    ...
    public void testFromStringSIP() {
        final UniformResourceName sipUrn = new UniformResourceName(OAISIdentifier.SIP, AipType.COLLECTION, "CDPP",
                UUID.randomUUID(), 1);
    ...
    public void testFromStringFullAIP() {
        final UniformResourceName aipUrn = new UniformResourceName(OAISIdentifier.AIP, AipType.COLLECTION, "CDPP",
