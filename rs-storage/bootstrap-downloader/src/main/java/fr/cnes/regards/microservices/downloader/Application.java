 ...
 */
package fr.cnes.regards.microservices.downloader;
...
/**
 * Start microservice downloader.
 * Copy of the storage service run with the downloader profile.
 * See bootstrap.properties to see used profiles.
 *
 * @author Binda Sébastien
 */
@SpringBootApplication(scanBasePackages = { "fr.cnes.regards.modules", "fr.cnes.regards.contrib" })
@MicroserviceInfo(name = "downloader", version = "1.0.0")
