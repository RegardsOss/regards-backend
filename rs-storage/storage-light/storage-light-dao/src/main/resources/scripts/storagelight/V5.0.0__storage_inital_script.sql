...
create table t_storage_location_conf (plugin_conf_id int8 not null, priority int8, allocated_size_ko int8, storage_type varchar(255), primary key (storage_conf_id));
