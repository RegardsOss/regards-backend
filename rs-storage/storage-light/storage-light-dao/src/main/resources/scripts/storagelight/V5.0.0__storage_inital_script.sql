...
create table t_file_restoration_request (id int8 not null, error_cause varchar(512), file_destination_path varchar(255), origin_storage varchar(128), status varchar(255) not null, file_ref_id int8, primary key (id));
...
create sequence seq_file_restoration_request start 1 increment 50;
...
alter table t_file_restoration_request add constraint FKfrr17d4xaxdk88c59ne2nkbi7 foreign key (file_ref_id) references t_file_reference;
