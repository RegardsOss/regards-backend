...
alter table t_prioritized_data_storage add constraint FKbyoum2a2sb9eny7qtf2t6sf4t foreign key (data_storage_conf_id) references t_plugin_configuration;
...
alter table ta_file_ref_request_owners add constraint FK27luaqenqcsv6a521j7alk3xv foreign key (file_ref_id) references t_file_reference_request;
alter table ta_file_ref_types add constraint FKexnpqf3rka8vyvp2ysb1t3its foreign key (file_ref_id) references t_file_reference;
