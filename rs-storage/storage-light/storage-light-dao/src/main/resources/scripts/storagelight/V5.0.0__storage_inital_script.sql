...
create table t_request_result_info (id int8 not null, request_checksum varchar(128) not null, error boolean, error_cause varchar(512), group_id varchar(128) not null, request_type varchar(255) not null, request_storage varchar(128), result_file_ref_id int8, primary key (id));
...
alter table t_request_result_info add constraint FK278nmeardgw7tpeivopyrrct0 foreign key (result_file_ref_id) references t_file_reference;
