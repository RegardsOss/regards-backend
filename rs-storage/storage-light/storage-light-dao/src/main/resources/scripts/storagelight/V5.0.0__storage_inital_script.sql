...
create table t_storage_location_conf (storage_conf_id int8 not null, priority int8, allocated_size_ko int8, storage_type varchar(255), primary key (storage_conf_id));
...
alter table t_storage_location_conf add constraint uk_storage_location_conf unique (storage_type, priority);
...
alter table t_storage_location_conf add constraint FKj8h3r7gds36k6uvtequf2d5p foreign key (storage_conf_id) references t_plugin_configuration;
