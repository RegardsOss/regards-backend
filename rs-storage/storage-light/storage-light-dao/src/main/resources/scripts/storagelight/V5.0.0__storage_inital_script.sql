...
create table t_file_deletion_request (file_reference int8 not null, error_cause varchar(512), status varchar(255) not null, storage varchar(128) not null, primary key (file_reference));
