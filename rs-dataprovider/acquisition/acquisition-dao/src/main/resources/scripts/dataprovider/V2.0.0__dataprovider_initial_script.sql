...
create table t_acquisition_file (id int8 not null, acquisition_date timestamp, checksum varchar(255), checksumAlgorithm varchar(16), error text, filePath varchar(255), state varchar(16), acq_file_info_id int8, product_id int8, primary key (id));
