...
create table t_acq_processing_chain (id int8 not null, active boolean, datasetIpId varchar(256), ingest_chain varchar(255), label varchar(64) not null, last_activation_date timestamp, locked boolean not null, mode varchar(16), period int8, session varchar(50), generatesip_conf_id int8, acq_job_info_id uuid, postprocesssip_conf_id int8, product_conf_id int8, validation_conf_id int8, primary key (id));
