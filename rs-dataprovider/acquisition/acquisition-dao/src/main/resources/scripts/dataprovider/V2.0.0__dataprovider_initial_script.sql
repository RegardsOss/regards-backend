...
create table t_acq_processing_chain (id int8 not null, active boolean, datasetIpId varchar(256), ingest_chain varchar(255), label varchar(64) not null, last_activation_date timestamp, mode varchar(16), period int8, running boolean not null, session varchar(50), generatesip_conf_id int8, acq_job_report_id int8, postprocesssip_conf_id int8, product_conf_id int8, validation_conf_id int8, primary key (id));
