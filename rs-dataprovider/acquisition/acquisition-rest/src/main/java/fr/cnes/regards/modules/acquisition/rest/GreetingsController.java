...
import fr.cnes.regards.modules.acquisition.service.GreetingsService;
 ...
 */
@RestController
@ModuleInfo(name="acquisition-rest", version="2.0.0-SNAPSHOT", author="REGARDS", legalOwner="CS", documentation="http://test")
@RequestMapping("/api")
