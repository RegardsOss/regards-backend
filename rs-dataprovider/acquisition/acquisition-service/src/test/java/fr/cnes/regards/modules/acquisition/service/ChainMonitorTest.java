...
public class ChainMonitorTest extends DataproviderMultitenantServiceTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChainMonitorTest.class);
