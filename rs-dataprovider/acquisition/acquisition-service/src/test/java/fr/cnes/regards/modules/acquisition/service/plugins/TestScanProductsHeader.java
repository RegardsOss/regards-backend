 ...
 */
@Plugin(id = "TestScanProductsHeader", version = "1.0.0-SNAPSHOT",
        description = "TestScanProductsHeader", author = "REGARDS Team",
        contact = "regards@c-s.fr", licence = "LGPLv3.0", owner = "CSSI", url = "https://github.com/RegardsOss")
public class TestScanProductsHeader extends AbstractAcquisitionScanPlugin
        implements IAcquisitionScanDirectoryPlugin {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(TestScanProductsHeader.class);
