...
/**
 * Check's plugin for Spot4 products using Doris1B instrument.<br>
 * This {@link Plugin} checks that the file exists and is accessible and add a prefix to the product name.
 * 
 * @author Christophe Mertz
 *
 */
@Plugin(description = "Check's plugin for Spot4 products using Doris1B instrument", id = "Spot4Doris1BCheckingPlugin", version = "1.0.0",
