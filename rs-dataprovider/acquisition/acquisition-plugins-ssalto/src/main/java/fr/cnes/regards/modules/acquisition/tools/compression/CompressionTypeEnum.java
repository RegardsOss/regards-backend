...
public class CompressionTypeEnum {
     ...
     */
    public final static CompressionTypeEnum ZIP = new CompressionTypeEnum("ZIP", "zip");

    /**
     * Constante definissant le mode GZIP
     */
    public final static CompressionTypeEnum GZIP = new CompressionTypeEnum("GZIP", "gz");

    /**
     * Constante définissant le mode TAR
     */
    public final static CompressionTypeEnum TAR = new CompressionTypeEnum("TAR", "tar");

    /**
     * Constante definissant le mode Z (Unix Compress)
     */
    public final static CompressionTypeEnum Z = new CompressionTypeEnum("Z", "z");
