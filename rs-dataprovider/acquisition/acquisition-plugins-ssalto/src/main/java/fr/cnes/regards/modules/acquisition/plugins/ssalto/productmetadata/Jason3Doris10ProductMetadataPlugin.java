 ...
 */
@Plugin(description = "Metadata caculation's plugin for Jason3 using Doris1B instrument",
        id = "Jason3Doris10ProductMetadataPlugin", version = "1.0.0", author = "REGARDS Team",
