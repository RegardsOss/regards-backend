 ...
 */
public class StringAttributeControler extends AttributeControler {
    ...
    public StringAttributeControler() {
        super();
    }
     ...
     */
    public static String getValue(StringAttribute pAttribut, int pIndex) throws ModuleException {
