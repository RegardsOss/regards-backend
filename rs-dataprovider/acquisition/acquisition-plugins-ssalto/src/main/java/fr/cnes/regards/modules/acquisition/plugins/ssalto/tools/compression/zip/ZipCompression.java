 ...
 */
package fr.cnes.regards.modules.acquisition.plugins.ssalto.tools.compression.zip;
...
import fr.cnes.regards.modules.acquisition.plugins.ssalto.tools.compression.AbstractRunnableCompression;
import fr.cnes.regards.modules.acquisition.plugins.ssalto.tools.compression.CompressManager;
...
public class ZipCompression extends AbstractRunnableCompression {
    ...
    protected CompressManager runCompress(List<File> pFileList, File pCompressedFile, File pRootDirectory,
            boolean pFlatArchive, Charset pCharset,
            fr.cnes.regards.modules.acquisition.plugins.ssalto.tools.compression.CompressManager pCompressManager)
