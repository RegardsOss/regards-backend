...
/**
 * Metadata caculation's plugin for Jason2 Gpsp10_FLOT products.<br>
 * The TIME_PERIOD attribute is managed specifically.
 *
 * @author Christophe Mertz
 */
@Plugin(description = "Metadata caculation's plugin for Jason2 Gpsp10_FLOT products",
        id = "Jason2Gpsp10FlotProductMetadataPlugin", version = "1.0.0", author = "REGARDS Team",
