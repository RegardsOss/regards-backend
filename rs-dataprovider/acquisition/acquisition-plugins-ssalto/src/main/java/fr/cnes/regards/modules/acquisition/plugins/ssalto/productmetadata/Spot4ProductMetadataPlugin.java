...
/**
 * Metadata caculation's plugin for SPOT4 products.
 * 
 * @author Christophe Mertz
 *
 */
@Plugin(description = "Metadata caculation's plugin for SPOT4 products", id = "Spot4ProductMetadataPlugin", version = "1.0.0",
