...
public class Jason2Gpsp10FlotPluginIT extends AbstractProductMetadataPluginTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(Jason2Gpsp10FlotPluginIT.class);
