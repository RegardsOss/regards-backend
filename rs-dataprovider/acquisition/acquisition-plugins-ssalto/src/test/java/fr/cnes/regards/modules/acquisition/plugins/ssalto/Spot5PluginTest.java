...
import fr.cnes.regards.modules.acquisition.plugins.ssalto.productmetadata.Spot5ProductMetadataPlugin;
...
public class Spot5PluginTest extends AbstractProductMetadataPluginTest {
    ...
    public ISIPGenerationPluginWithMetadataToolbox buildPlugin(String datasetName) throws ModuleException {
        PluginConfiguration pluginConfiguration = this
                .getPluginConfiguration("Spot5ProductMetadataPlugin",
                                        Optional.of(PluginParametersFactory.build()
                                                .addParameter(AbstractProductMetadataPlugin.DATASET_SIP_ID, datasetName)
                                                .addParameter(Spot5ProductMetadataPlugin.ARC_FILE_PATH_PARAM,
                                                              "src/test/resources/income/data/spot5/arcs/SPOT5_ARCS")
                                                .getParameters()));
