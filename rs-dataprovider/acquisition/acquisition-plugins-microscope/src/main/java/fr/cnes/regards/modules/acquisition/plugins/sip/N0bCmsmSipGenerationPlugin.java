...
/**
 * N0b_CMSM product SIP generation based upon N0bGnssSipGenerationPlugin
 * @author Olivier Rousselot
 */
@Plugin(id = "N0bCmsmSipGenerationPlugin", version = "1.0.0-SNAPSHOT",
        description = "N0b_CMSM product SIP generation plugin", author = "REGARDS Team", contact = "regards@c-s.fr",
        licence = "LGPLv3.0", owner = "CSSI", url = "https://github.com/RegardsOss")
public class N0bCmsmSipGenerationPlugin extends N0bGnssSipGenerationPlugin {

    @Override
    protected File findDataFile(Path metadataFilePath, String filename) throws IOException {
        return MicroHelper
                .findFileWithExtension(MicroHelper.findDirStartingWithSameName(metadataFilePath), Microscope.TGZ_EXT);
    }
    ...
    protected void addDescriptiveInformations(SIPBuilder sipBuilder, Document doc) throws MetadataException {
        ...
        sipBuilder.addDescriptiveInformation(Microscope.SCOPE, MicroHelper.getTagValue(doc, Microscope.N0_TYPE_TAG));
    }
