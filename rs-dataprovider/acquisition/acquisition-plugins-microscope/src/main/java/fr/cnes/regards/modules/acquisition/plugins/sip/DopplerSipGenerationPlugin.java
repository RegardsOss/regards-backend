...
/**
 * DOPPLER product SIP generation based upon FromMetadataSipGenerationPlugin
 * @author Olivier Rousselot
 */
@Plugin(id = "DopplerSipGenerationPlugin", version = "1.0.0-SNAPSHOT",
        description = "DOPPLER product SIP generation plugin", author = "REGARDS Team", contact = "regards@c-s.fr",
        licence = "LGPLv3.0", owner = "CSSI", url = "https://github.com/RegardsOss")
public class DopplerSipGenerationPlugin extends FromMetadataSipGenerationPlugin {
    ...
    protected void addDescriptiveInformations(SIPBuilder sipBuilder, Document doc) throws MetadataException {
        ...
        sipBuilder
                .addDescriptiveInformation(Microscope.STATION, MicroHelper.getTagValue(doc, Microscope.STATION_ID_TAG));
    }
