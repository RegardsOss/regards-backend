...
/**
 * N0c_CMSM product SIP generation based upon N0bGnssSipGenerationPlugin
 * @author Olivier Rousselot
 */
@Plugin(id = "N0cCmsmSipGenerationPlugin", version = "1.0.0-SNAPSHOT",
        description = "N0c_CMSM product SIP generation plugin", author = "REGARDS Team", contact = "regards@c-s.fr",
        licence = "LGPLv3.0", owner = "CSSI", url = "https://github.com/RegardsOss")
public class N0cCmsmSipGenerationPlugin extends N0bCmsmSipGenerationPlugin {
    ...
    protected void addDescriptiveInformations(SIPBuilder sipBuilder, Document doc) throws MetadataException {
        ...
        sipBuilder.addDescriptiveInformation(Microscope.SESSION,
                                             MicroHelper.getTagValue(doc, Microscope.SESSION_SEQUENCE_NUMBER_TAG));
    }
