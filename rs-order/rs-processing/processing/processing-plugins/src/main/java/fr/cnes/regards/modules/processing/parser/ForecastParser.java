package fr.cnes.regards.modules.processing.parser;

import fr.cnes.regards.modules.processing.domain.duration.AbsoluteRunningDurationForecast;
import fr.cnes.regards.modules.processing.domain.duration.IRunningDurationForecast;
import fr.cnes.regards.modules.processing.domain.duration.MultiplierRunningDurationForecast;
import fr.cnes.regards.modules.processing.domain.size.AbsoluteResultSizeForecast;
import fr.cnes.regards.modules.processing.domain.size.IResultSizeForecast;
import fr.cnes.regards.modules.processing.domain.size.MultiplierResultSizeForecast;
