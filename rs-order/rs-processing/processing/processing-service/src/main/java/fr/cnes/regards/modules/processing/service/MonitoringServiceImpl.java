...
public class MonitoringServiceImpl implements IMonitoringService {
    ...
    private Mono<Page<PExecution>> getPExecutionsPageForCriteria(String tenant, List<ExecutionStatus> status,
    ...
    public Mono<Page<ExecutionMonitoringDTO>> getExecutionsPageForCriteria(
        ...
        return getPExecutionsPageForCriteria(tenant, status, userEmail, from, to, paged)
            .flatMap(page ->
