...
public interface IExecutionEntityRepository extends ReactiveCrudRepository<ExecutionEntity, UUID> {
     ...
     */
    @Query(" SELECT * " + " FROM t_execution AS E " + " WHERE E.current_status = 'RUNNING' "
    ...
    Flux<ExecutionEntity> findByTenantAndCurrentStatusInAndLastUpdatedAfterAndLastUpdatedBefore(String tenant,
