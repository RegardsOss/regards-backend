...
public interface IProcessingRestClient {
    ...
    @RequestMapping(method = RequestMethod.GET, path = PROCESS_PATH, produces = APPLICATION_JSON)
    List<PProcessDTO> listAll();

    @RequestMapping(method = RequestMethod.PUT, path = PROCESS_PATH, produces = APPLICATION_JSON)
