...
create table t_dataset_task (dataset_ip_id varchar(128) not null, dataset_label varchar(128) not null, files_count int4, files_size int8, objects_count int4, selection_request jsonb, processing_service text, id int8 not null, order_id int8, primary key (id));
