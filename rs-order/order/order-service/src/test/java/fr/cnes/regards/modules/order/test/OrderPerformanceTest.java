...
public class OrderPerformanceTest extends AbstractMultitenantServiceTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(OrderPerformanceTest.class);
    ...
    public void test() {
        ...
        orderService.completeOrderCreation(basket, order, DefaultRole.REGISTERED_USER.toString());
