...
@TestPropertySource(properties = {
        "spring.jpa.properties.hibernate.default_schema=order_processing_test_it_scope_suborder_card_oneperfeature",
})
@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_CLASS)
public class OrderProcessingServiceScopeSuborderCardinalityOnePerFeatureIT extends AbstractOrderProcessingServiceIT {
