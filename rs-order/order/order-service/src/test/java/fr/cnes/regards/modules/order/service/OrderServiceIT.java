...
import fr.cnes.regards.modules.order.domain.StatedDataFile;
...
public class OrderServiceIT {
    ...
    public void testMapping() throws URISyntaxException {
        ...
        Order orderFromDb = orderRepository.findOneById(order.getId());
        System.out.println("-----------------------------------------------");
