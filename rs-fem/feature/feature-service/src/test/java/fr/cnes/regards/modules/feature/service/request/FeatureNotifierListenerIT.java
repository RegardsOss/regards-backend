...
public class FeatureNotifierListenerIT extends AbstractFeatureMultitenantServiceTest {
    ...
    public void testReceivingNotifierEventThatCreatesFeatureUpdateDisseminant() {
        ...
        HashSet<Recipient> recipients = Sets.newLinkedHashSet(
        ...
        Optional<FeatureUpdateDisseminationRequest> recipientLabelRequiredRequestOpt = featureUpdateDisseminationRequests.stream()
                .filter(request -> request.getRecipientLabel().equals(recipientLabelRequired)).findFirst();
        Optional<FeatureUpdateDisseminationRequest> recipientLabelNotRequiredRequestOpt = featureUpdateDisseminationRequests.stream()
                .filter(request -> request.getRecipientLabel().equals(recipientLabelNotRequired)).findFirst();
        ...
        assertEquals("should get good mode", FeatureUpdateDisseminationInfoType.PUT,
        ...
        assertEquals("should retrieve feature urn", abstractFeatureRequests.get(0).getUrn(), recipientLabelRequiredRequest.getUrn());
        assertEquals("should retrieve feature urn", abstractFeatureRequests.get(0).getUrn(), recipientLabelNotRequiredRequest.getUrn());
    }
