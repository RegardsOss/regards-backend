 ...
 **/
@Service
public class RequestTtlCustomizer extends AbstractSimpleDynamicSettingCustomizer {

    public RequestTtlCustomizer() {
        super(DeliverySettings.REQUEST_TTL_HOURS, "parameter [request time to live] must be a valid positive number");
    }
